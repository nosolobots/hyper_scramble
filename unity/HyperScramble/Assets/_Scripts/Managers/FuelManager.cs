...
public class FuelManager : PersistentSingleton<FuelManager>
{
    [Header("UI Elements")]
    ...
    [SerializeField] AudioClip noFuelSound;
    ...
    IEnumerator FuelMonitorWarning()
    {
        while (true)
        {
            ...
            else if (_fuel < maxFuel * alarmThreshold && !isOutOfFuel)
            {
                ...
                AudioSystem.Instance.PlayFXSound(fuelWarningSound);
            }
    ...
    private void OutOfFuel()
    {
        ...
        AudioSystem.Instance.PlayFXSound(noFuelSound);
